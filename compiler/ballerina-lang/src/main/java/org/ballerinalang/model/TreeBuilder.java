...
public class TreeBuilder {
    ...
    public static EndpointTypeNode createEndpointTypeNode() {
        return new BLangEndpointTypeNode();
    }
    ...
    public static WorkflowNode createWorkflowNode() {
        return new BLangWorkflow();
    }
    ...
    public static ReceiveNode createReceiveNode() {
        return new BLangReceive();
    }
}
