...
public class WorkflowInfo extends CallableUnitInfo {
    ...
    public WorkflowInfo(int pkgCPIndex, String pkgPath, int wfNameCPIndex, String actionName) {
        this.pkgPath = pkgPath;
        this.pkgCPIndex = pkgCPIndex;
        this.name = actionName;
        this.nameCPIndex = wfNameCPIndex;
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof WorkflowInfo
                && pkgCPIndex == (((WorkflowInfo) obj).pkgCPIndex)
                && nameCPIndex == (((WorkflowInfo) obj).nameCPIndex);
    }
